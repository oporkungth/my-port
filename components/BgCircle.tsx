  ...
  return (
    ...
    className='relative flex justify-center items-center'>
        ...
        <div className='rounded-full border border-[#333333] h-[400px] w-[400px] absolute
         mt-52'/>
        <div className='rounded-full border border-[#white] opacity-20 h-[550px] w-[550px] absolute
         mt-52 animate-pulse'/>
        <div className='rounded-full border border-[#333333] opacity-20 h-[650px] w-[650px] absolute
         mt-52' />
    </motion.div>
  )
}
